...
use Exception;
use common\modules\notification\components\behaviors\PolymorphicRelation;
...
use common\modules\content\interfaces\ContentOwner;
use common\modules\content\widgets\richtext\RichText;
use yii\helpers\Json;
use yii\helpers\Url;
use common\modules\notification\renderer\Viewable;
 ...
 * ActiveRecord.
 *
 * Since SocialActivities need to be rendered in most cases it implements the common\components\rendering\Viewable interface and provides
 * a default implementation of the getViewParams function.
 *
 * @since 1.1
 * @author buddha
 */
abstract class SocialActivity extends \yii\base\Object implements Viewable, \Serializable
{
     ...
     * @return \common\components\SocialActivity
     */
     ...
     *
     * @return \common\modules\content\models\Content Content ActiveRecord or null if not related to a ContentOwner source
     */
    ...
    {
        return Json::encode($this->asArray($this->originator));
    }
