/**
 * @link https://www.app.org/
 * @copyright Copyright (c) 2017 app GmbH & Co. KG
 * @license https://www.app.com/licences
 */
app.module('notification', function (module, require, $) {
    ...
    NotificationDropDown.prototype.init = function (update) {
        ...
        var that = this;
        event.on('app:modules:notification:live:NewNotification', function (evt, events, update) {
    ...
    NotificationDropDown.prototype.updateCount = function ($count) {
        ...
        event.trigger('app:notification:updateCount', [$count]);
