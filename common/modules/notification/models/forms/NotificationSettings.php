...
use common\modules\admin\permissions\ManageSettings;
...
class NotificationSettings extends Model
{
    ...
    /**
     * @var \common\modules\user\models\User instance for which the settings should by appleid, if null global settings are used.
     */
    public $user;
