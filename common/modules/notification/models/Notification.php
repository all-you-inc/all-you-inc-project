...
use common\modules\notification\components\ActiveRecord;
use Yii;
...
class Notification extends ActiveRecord {
    ...
    const Message = 'InternalMessageRecevied';
     ...
     *
     * @return \common\components\ActiveRecord
     */
    ...
    public static function getModuleNotifications() {
        ...
        foreach (Yii::$app->moduleManager->getModules(['includeCoreModules' => true]) as $module) {
            if ($module instanceof \common\components\Module) {
