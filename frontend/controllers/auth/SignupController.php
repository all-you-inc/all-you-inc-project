...
//    UserMlmService::createSignupMlm('7Y7Nr0333VqMsDOmJfOBV5Hqr6Ql1a6a', '3.99', 69);
    }
...
//                    create user tiers without limitations
                    UserReferralService::createReferrals($_GET['referral'], $form->email);
                }
    ...
    public function actionPlan() {
        ...
        if (Yii::$app->request->post()) {
            ...
            if ($user->isUserCardNeedToAdd($membership_id)) {
                if ($user->isUserNeedToAddInSquare() || !$user->isUserCardEXist()) {
                    return $this->redirect(['square/details', 'id' => $membership_id, 'request' => 'membership']);
                }
            }
