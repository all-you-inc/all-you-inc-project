        ...
        <div class="col-lg-9 order-lg-last dashboard-content">
            ...
            <div class="row">
                ...
                <?php if (\Yii::$app->user->identity->getUser()->canShowBothTalent()) { ?>
                    ...
                    <?php } ?>
                    <?php if (\Yii::$app->user->identity->getUser()->isPromoter()) {
                        $shareUrl = Url::base('http').Url::to(['/signup?referral='.$model->referral_code]);
                        ?>
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-header">
                                ...
                                <div class="card-body">
                                    <strong>Link :</strong><a target="_blank" href="<?= $shareUrl?>"><?= $shareUrl?></a>
                                </div><!-- End .card-body -->
                            </div><!-- End .card -->
                        </div><!-- End .col-md-6 -->
                        <?php } ?>
...
//                                                if ($subscription->type == 'addons') {
                                                    ?>
                                                    <?php // $subscription->itemType->title ?> 
                                                    <strong><?php // $subscription->unit == 0 ? '' : $subscription->unit ?></strong>
                                                    <br>
                                                    <?php
//                                                }
//                                            }
